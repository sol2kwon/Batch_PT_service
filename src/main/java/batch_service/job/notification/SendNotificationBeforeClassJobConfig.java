package batch_service.job.notification;

import batch_service.repository.booking.BookingEntity;
import batch_service.repository.booking.BookingStatus;
import batch_service.repository.notification.NotificationEntity;
import batch_service.repository.notification.NotificationEvent;
import batch_service.repository.notification.NotificationModelMapper;
...
//한개의 잡에서 두개의 스텝으로 나눈다.(노티피케이션을 생성, 노티피케이션을 전송)
@Configuration
