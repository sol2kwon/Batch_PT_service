...
import batch_service.repository.pass.*;
import batch_service.repository.user.UserGroupMappingEntity;
import batch_service.repository.user.UserGroupMappingRepository;
...
public class AddPassesTasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        final List<BulkPassEntity> bulkPassEntities = bulkPassRepository.finByStatusAndStartedAtGreaterThan(BulkPassStatus.READY, startedAt);
